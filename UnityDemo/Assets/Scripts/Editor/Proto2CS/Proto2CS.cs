...
namespace ET
{
    ...
    {
        private const string protoDir = "../UnityDemo/Assets/Config/Proto";
        private const string clientMessagePath = "../UnityDemo/Assets/Scripts/Codes/Model/Generate/Client/Message/";
        private const string serverMessagePath = "../UnityDemo/Assets/Scripts/Codes/Model/Generate/Server/Message/";
        private const string clientServerMessagePath = "../UnityDemo/Assets/Scripts/Codes/Model/Generate/ClientServer/Message/";
